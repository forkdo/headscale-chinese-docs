...
Headscale 支持 Tailscale 标签。请阅读 [Tailscale 的标签文档](https://tailscale.com/docs/features/tags) 以了解标签的工作原理以及如何使用它们。
...
通常，系统会打开一个浏览器窗口并显示进一步的操作说明。该页面说明了如何在 Headscale 服务器上完成注册，并会打印出批准节点所需的 Auth ID：
